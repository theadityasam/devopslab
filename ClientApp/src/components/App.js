  ...
  return (
    <Layout style={{height: '100vh',overflow:'hidden'}}>
      ...
      <Layout className="site-layout">
        <Header className="site-layout-background" style={{ padding: 0,color:'white',textAlign:'center',fontSize:'30px',fontWeight:'medium',fontFamily:'Roboto'}}><AntCloudOutlined />  DevOpslab @ CodeStreet</Header>
        <Content style={{ margin: '0 16px' }}>                       
          <Aditya name="AdityaTest" />
          <UserForm
            addUsers={addUsers}
          />            
        ...
        <Footer style={{ textAlign: 'center' }}>DevOpsLab©2020</Footer>
      </Layout>
    </Layout>
  );
}
