    ...
    const findUser=()=>{
        ...
        .then(data=>{
            if(data.message=="Not Found"){
                ...
                setAlert(true);
                setAlertMsg(`Only comparisons between users will be allowed.And, also ${data.name} is a great organization.`);
                setUsername("");
            }else{
    ...
    return (
        <div style={{marginTop:'5vh'}}>
            ...
            <Input
                ...
                placeholder="Enter a github username (eg. theadityasam)"
